...
[
   ...
   check("antiquity", "antiquity debe ser un entero").optional().isInt(),
   check("mtsCovered", "mtsCovered debe ser un entero").optional().isInt(),
   check("mtsHalfCovered", "mtsHalfCovered debe ser un entero").optional().isInt(),
   check("mtsUncovered", "mtsUncovered debe ser un entero").optional().isInt(),
   check("numEnvironments", "numEnvironments debe ser un entero").optional().isInt(),
   check("numRooms", "numRooms debe ser un entero").optional().isInt(),
   check("numBathrooms", "numBathrooms debe ser un entero").optional().isInt(),
   check("numCars", "numCars debe ser un entero").optional().isInt(),
